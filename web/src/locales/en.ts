export default {
  translation: {
    ...
    header: {
      ...
      dataset: 'Dataset',
      memories: 'Memory',
      chatAnalytics: 'Q&A Analytics',
    },
    chatAnalytics: {
      title: 'Q&A Analytics',
      lifetimeCount: 'All-time Q&As',
      last30DaysCount: 'Q&As in the last 30 days',
      todayCount: "Today's Q&As",
      trendTitle: 'Q&A trend',
...
Example: Virtual Hosted Style`,
      ...
      ownedTeams: 'My teams',
      activeTeams: 'Active',
      invitedTeams: 'Pending invitations',
      teamName: 'Team name',
      memberCount: 'Members',
      datasetCount: 'Knowledge bases',
      deleteTeamWarning:
        'Knowledge bases will not be deleted and will automatically become visible only to me.',
      specifiedTeam: 'Specified team',
      ...
      teamOperationFailed: 'Team operation failed',
