export default {
  translation: {
    ...
    chatAnalytics: {
      title: '问答分析',
      lifetimeCount: '上线至今问答总次数',
      last30DaysCount: '过去30天问答次数',
      todayCount: '今日问答次数',
      trendTitle: '问答次数趋势',
      allAssistants: '全部聊天助理',
      assistant: '聊天助理',
      dateRange: '时间范围',
      byDay: '按天',
      byWeek: '按周',
...
例如：一条带有 1024 维嵌入的 1 KB 消息大约使用 9 KB。5 MB 的默认限制大约可容纳 500 条此类消息。`,
    ...
    knowledgeList: {
      ...
      categoryNotFound: '分类不存在或已被删除',
      categoryManageForbidden: '你没有权限管理该分类',
      categoryAssignForbidden: '你没有权限将知识库移动到该分类',
      loadCategoriesFailed: '加载分类失败',
      createCategoryFailed: '新建分类失败',
      renameCategoryFailed: '重命名分类失败',
      deleteCategoryFailed: '删除分类失败',
      moveDatasetFailed: '移动知识库失败',
      categoryActions: '{{name}} 的分类操作',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      syncNow: '立即同步',
      syncNowTip: '立即拉取 SVN 中新增或升版的文件，不删除或重建现有文档。',
      syncScheduled: '同步任务已提交。',
      baseInfo: '基础信息',
      globalIndex: '全局索引',
      dataSource: '数据源',
...
示例：general/v2/`,
      ...
      memberCount: '成员数',
      datasetCount: '知识库数',
      deleteTeamWarning: '知识库不会删除，将自动变为只有我',
      specifiedTeam: '指定团队',
      selectTeam: '请选择团队',
      acceptInvitation: '接受',
      rejectInvitation: '拒绝',
      leaveTeam: '退出团队',
      removeMember: '移除成员',
      confirmRemoveMember: '确定从团队中移除该成员吗？',
      memberActive: '已加入',
      memberInvited: '待接受',
      loadingTeams: '正在加载团队……',
      loadingMembers: '正在加载成员……',
      teamOperationFailed: '团队操作失败',
